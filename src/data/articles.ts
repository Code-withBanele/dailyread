...
export const seedArticles: Article[] = [
 ...
 // {
  ...
  excerpt: "The Manona Legacy and the Eastern Cape Tradition of Inquiry",
  category: "Heritage",
  author: "Zola Pinda",
  publishedAt: "2026-09-07",
  readingTime: "12 min read",
  featured: false,
  image: manonaPortrait,
  content: [
    { type: 'heading2', value: "The Eastern Cape tradition of inquiry" },
    { type: 'paragraph', content: "There is a tradition in the Eastern Cape that does not announce itself. It works in villages, mission schools and the spaces between languages: the researcher who returns to the people, the translator who carries earlier voices across time, and the observer who understands that social research is about lives being lived." },
    { type: 'paragraph', content: "Dr Wele Cecil Manona belonged to that tradition. His work ranged across anthropology, migration, rural development, local government, labour, translation and community life. Its significance lies not only in its breadth, but in his sustained attention to the people behind the structures he studied." },
    { type: 'paragraph', content: "His son, Dr Siyabulela Manona, represents a contemporary generation of research. The relationship between the two should not be romanticised or reduced to a simple inheritance. It is more useful to ask what survives across generations when serious research remains attentive to land, communities, evidence and the institutions that shape everyday life. That question begins in Peddie." },
    { type: 'heading2', value: "The formation" },
    { type: 'paragraph', content: "Wele Cecil Manona was born in Durban Location, Peddie, in 1937. He attended a Methodist mission school before proceeding to Healdtown. From there he entered broadcasting through the SABC's Xhosa radio service and became well known as a disc jockey. He later completed a BA with honours in Anthropology through Unisa and entered the research environment associated with Rhodes University and the Institute of Social and Economic Research (ISER)." },
    { type: 'paragraph', content: "Broadcasting was not simply a detour before anthropology. It gave him an intimate education in language, cadence and listening. The ability to hear how people describe their own circumstances would become central to his later fieldwork. The movement from radio to research therefore makes sense as a development in method: listen first, then investigate." },
    { type: 'paragraph', content: "At Rhodes, Manona became part of a research tradition that treated the Eastern Cape as a serious field of inquiry rather than a peripheral subject. The 2013 Rhodes University tributes describe him as a major facilitator for students, colleagues and visiting scholars working in the region. Professor Chris de Wet wrote that the depth and continuity of Manona's research made him one of the leaders in the field in the Eastern Cape, and described his contribution as a significant archive of insight into rural and urban social change." },
    // SABC Broadcast House, Commissioner Street, Johannesburg — historic context for the broadcasting years and early Radio Xhosa service. Source / rights: Artefacts.co.za — final rights check.
    { type: 'image', value: sabcBroadcastHouse, alt: "SABC Broadcast House, Commissioner Street, Johannesburg" },
    // SABC Auckland Park complex — later headquarters associated with Radio Xhosa / the Xhosa radio service. Source / rights: Artefacts.co.za — final rights check.
    { type: 'image', value: sabcAucklandPark, alt: "SABC Auckland Park complex" },
    { type: 'heading2', value: "The fieldwork" },
    { type: 'paragraph', content: "Manona's MA research took him to Burnshill in the Keiskammahoek area, a region already associated with the landmark Keiskammahoek Rural Survey. His work on migrant labour placed him inside a longer research tradition while developing its own questions about mobility, family, rural livelihoods and the changing social organisation of communities." },
    { type: 'paragraph', content: "The significance of this work becomes clearer when the fieldwork is viewed as a sequence rather than as isolated studies. Manona moved between rural communities, urban settlements, labour environments and institutions. He studied the consequences of migration, changes in land and agricultural life, local government, urban adaptation and labour relations. The recurring subject was social change — and the people required to live through it." },
    { type: 'paragraph', content: "Glenmore provides perhaps the clearest meeting point between Manona's scholarship and public responsibility. Rhodes University's own tribute records his involvement in the Glenmore Feeding Scheme and recounts that, while taking food to starving residents, he was stopped by police. That wording matters: the documentary record supports the police encounter; it does not require us to turn the episode into a stronger claim of formal arrest or detention." },
    { type: 'paragraph', content: "The wider Glenmore archive is equally important. The Cory Library's Klipfontein–Glenmore collection contains 84 photographs and associated material documenting the forced removals, affected families, officials, court proceedings and everyday conditions in the resettlement area. The photographs do something prose alone cannot do: they show the material consequences of policy at ground level." },
    { type: 'paragraph', content: "This is where the visual record and the scholarly record reinforce one another. The aerial photograph establishes the system. The temporary structures show the physical condition. The eviction notice gives the policy a human face. A responsible feature should resist turning suffering into spectacle; the purpose of these images is to restore the people and circumstances behind an abstract phrase such as “forced removal”." },
    // Ballantine's Mill, Keiskammahoek — visual context for the district associated with Manona's Burnshill research. Source / rights: The Heritage Portal / Franco Frescura Collection — final rights check.
    { type: 'image', value: ballantinesMill, alt: "Ballantine's Mill, Keiskammahoek" },
    // Archival visual record of the Eastern Cape communities affected by forced removals. Source / rights: archival collection — final item identification and publication rights to be confirmed.
    { type: 'image', value: glenmoreArchive, alt: "Archival visual record of the Eastern Cape communities affected by forced removals" },
    { type: 'heading2', value: "The rural economy and social change" },
    { type: 'paragraph', content: "In other field settings, Manona examined the weakening of agricultural livelihoods, land tenure and the movement from rural production towards non-agrarian livelihoods. His research also extended into Grahamstown East and other settlements where rural-urban migration changed household composition and the experience of work." },
    { type: 'paragraph', content: "The value of these studies lies in their attention to process. De-agrarianisation changes households, gender relations, migration decisions and the relationship between people and place. Urbanisation likewise reorganises social life, not merely where people live." },
    { type: 'paragraph', content: "At the Magwa Tea Estates, Manona studied labour relations. At Ford Motor Company, he worked on evaluations of the Sullivan Code. Rhodes University's 2013 tribute places these activities alongside his visits to pre-schools in deprived areas of Ciskei, the Glenmore Feeding Scheme and a study of a newly established resettlement community." },
    { type: 'paragraph', content: "The range is striking, but the method is consistent. Manona moved between institutions and communities without losing sight of the people inside them. He could work with corporate structures, local government, rural households and community initiatives while maintaining an interest in how systems were experienced on the ground." },
    // Fingo Village, Grahamstown East — housing conditions in communities associated with Manona's research. Source / rights: Zute Lightfoot Photography — final permission and attribution required.
    { type: 'image', value: fingoVillage, alt: "Fingo Village, Grahamstown East" },
    // Tea worker in the Eastern Cape, providing a human labour context to the Magwa research theme. Source / rights: photographer / publication source to be confirmed.
    { type: 'image', value: teaWorker, alt: "Tea worker in the Eastern Cape" },
    { type: 'heading2', value: "The translator" },
    { type: 'paragraph', content: "Another dimension of Manona's contribution lies in translation. The 2020 Wits University Press edition of D.D.T. Jabavu's In India and East Africa / E-Indiya nase East Africa identifies Cecil Wele Manona as the English translator. Translation in this context was not merely a technical service. It opened an isiXhosa intellectual text to readers beyond the original language and helped carry an older African intellectual record into a wider contemporary conversation." },
    { type: 'paragraph', content: "This is one of the quieter forms of public scholarship: making knowledge travel without stripping it of its origin. It is also one of the places where the relationship between scholarship and journalism becomes particularly clear. Both disciplines depend on the ability to move information responsibly from one context into another." },
    // Professor Davidson Don Tengo (DDT) Jabavu (1885–1959), whose travelogue Manona translated into English. Source / rights: South African History Online — final attribution and image rights check.
    { type: 'image', value: ddtJabavu, alt: "Professor Davidson Don Tengo (DDT) Jabavu (1885–1959)" },
    // D.D.T. Jabavu with his father John Tengo Jabavu, providing context for the intellectual and publishing tradition surrounding the translated work. Source / rights: South African History Online — final attribution and image rights check.
    { type: 'image', value: ddtWithFather, alt: "D.D.T. Jabavu with his father John Tengo Jabavu" },
    { type: 'heading2', value: "The inheritance" },
    { type: 'paragraph', content: "The intellectual baton did not fall; it moved into another generation. Dr Siyabulela Manona represents a contemporary research life of his own. The responsible way to describe the relationship is not to suggest that father and son conducted identical work, but to recognise a family and regional conversation around evidence, land, institutions, communities and lived experience." },
    { type: 'paragraph', content: "That distinction is important. A son's work should stand on its own terms, just as a father's scholarship should not be reduced to the achievements of his children. What matters here is the possibility of intellectual continuity without intellectual simplification." },
    { type: 'heading2', value: "The journalism argument" },
    { type: 'paragraph', content: "The Eastern Cape does not need more commentary for commentary's sake. It needs sustained journalism that knows the difference between opinion and evidence, between a striking anecdote and a documented record, and between describing a community and actually listening to it." },
    { type: 'paragraph', content: "The strongest tradition of South African journalism understood that public-interest reporting begins with disciplined curiosity. The old Rand Daily Mail demonstrated the value — and the cost — of journalism that tested official accounts, investigated conditions affecting vulnerable people and insisted on verification. Its history also shows why evidence matters: powerful reporting is strongest when the facts can withstand scrutiny." },
    { type: 'paragraph', content: "That discipline is relevant to Manona's legacy. The scholar listens before interpreting. The journalist should do the same. The researcher establishes context. The journalist should do the same. The fieldworker distinguishes what was observed from what was inferred. The journalist must do the same. And both ultimately owe something to the people whose lives provide the material of their work." },
    { type: 'heading2', value: "The responsibility of AHNN" },
    { type: 'paragraph', content: "The Manona legacy is therefore not simply a subject to be covered. It is a method to be respected: listen carefully, establish context, distinguish evidence from assertion, acknowledge uncertainty, and return knowledge to the public in language people can use." },
    { type: 'paragraph', content: "That is the editorial proposition of the Africa Heritage News Network. When scholarship meets journalism — when the discipline of the fieldworker meets the reach of the writer — the result should not be merely more information. It should be deeper public understanding." },
    { type: 'paragraph', content: "And understanding, returned to the people, is what journalism is for." },
    { type: 'heading2', value: "ABOUT THE AUTHOR" },
    // Zola Pinda — Founder and Executive Chairman, Africa Heritage News Network (AHNN).
    { type: 'image', value: zolaPinda, alt: "Zola Pinda" },
    { type: 'paragraph', content: "Zola Pinda is Founder and Executive Chairman of the Africa Heritage News Network (AHNN). A journalist, communications strategist and public-affairs writer, he holds a BA in Journalism from Rhodes University and an MA in Professional and Business Communication from La Salle University, Philadelphia. He has held senior communications and public-sector leadership roles, including work within South Africa's National Prosecuting Authority and Directorate of Special Operations, and later at Assistant Director-General level in the national Department of Agriculture." },
    { type: 'paragraph', content: "His writing focuses on journalism, governance, history, public accountability, development, geopolitics and African public affairs." },
    { type: 'heading2', value: "EDITOR'S NOTE" },
    { type: 'paragraph', content: "This article forms part of AHNN's commitment to recovering African intellectual, historical and community records through serious, evidence-based journalism. Where archival, institutional or family material is available, AHNN seeks to engage primary sources while maintaining independent editorial responsibility. The purpose is not simply to remember individuals, but to understand the ideas, institutions and communities through which their contributions acquired meaning." },
